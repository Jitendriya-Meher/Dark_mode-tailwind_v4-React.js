  ...
  return (
    <div className=" isolate">
        ...
        <div className=" flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
          <div className=" flex-1 space-y-6 lg:space-y-7">
            <div className=" space-y-4 lg:space-y-5">
              ...
              <p className=" text-base lg:text-lg text-neutral-700 dark:text-neutral-700 max-w-2xl font-light">
            ...
            <div className="flex flex-wrap gap-3 lg:gap-4">
              <button className=" px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-900 hover:bg-black text-white dark:bg-amber-500 dark:hover:bg-amber-600 dark:text-neutral-900 font-medium shadow-lg hover:shadow-neutral-900/20 dark:hover:shadow-amber-500/20 flex items-center justify-center transition group">
              ...
              <button
                className=" px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-100 hover:bg-neutral-200
                        dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-900 dark:text-white font-medium flex items-center justify-center transition group border border-neutral-300 dark:border-neutral-700"
              >
                <i className="bx bx-book-open mr-2 lg:mr-3 text-lg lg:text-xl group-hover:opacity-100 opacity-70 transition-transform "></i>
            ...
            <div className=" flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800">
              <div className="flex -space-x-3">
                <img
                  ...
                  alt=""
                  className=" w-9 h-9 rounded-full object-cover lg:h-10 lg:w-10 border-2 border-white dark:border-neutral-900"
                />
                ...
                <span className=" flex items-center justify-center w-9 h-9 rounded-full object-cover lg:h-10 lg:w-10 border-2 border-white dark:border-neutral-900 text-xs font-medium bg-neutral-900 dark:bg-amber-500 text-white dark:text-neutral-900">
                  +5K
                </span>
              </div>
          ...
          <div className="flex-1 w-full">
            <div className=" relative">
              ...
              <div className=" relative bg-white dark:bg-neutral-900 p-4 lg:p-5 rounded-2xl shadow-2xl border  border-neutral-200 dark:border-neutral-800">
                ...
                <div className=" h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative">
                    <img src="/code-light.png" className=" w-full h-full object-cover object-left-top dark:hidden" alt="" />
                    <img src="/code-dark.png" className=" w-full h-full object-cover object-left-top dark:block" alt="" />
                    <div className=" absolute bottom-4 right-4">
                        <div className=" w-12 h-12 lg:h-14 lg:w-14 rounded-full bg-gradient-to-r from-amber-500 to-indigo-900 flex items-center justify-center text-white shadow-lg animate-pulse">
                ...
                <div className=" mt-3 lg:mt-4 flex justify-between items-center">
                    <div className=" flex gap-2">
                        ...
                        <span className=" px-2.5 py-1 lg:px-3 rounded-full bg-neutral-100 dark:bg-neutral-800 text-indigo-900 dark:text-indigo-400 border-2 border-neutral-200 dark:border-neutral-700 text-xs font-medium flex items-center">
                            <i className="bx bxl-react-css mr-1"></i>
                            React
                        </span>
                    </div>
                    <button className=" w-8 h-8 lg:w-9 lg:h-9 xl:w-10 xl:h-10 flex items-center justify-center rounded-full bg-amber-500 text-neutral-900 hover:bg-amber-600 transition cursor-pointer"
                    onClick={() => {
                      window.Clipboard.copytext("@custom-variant dark (&:where(.dark, .dark *));");
                    }}
                    >
      ...
      <div className=" hidden md:block absolute bottom-8 left-8 lg:bottom-10 lg:left-10 animate-bounce">
        <div className=" bg-neutral-900 text-white px-2.5 py-2.5 rounded-lg text-sm lg:test-sm flex items-center shadow-lg">
